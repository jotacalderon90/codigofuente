    	...
    	base._start = function(){
			...
			if (base.options.slides.length > 1){
				if(base.options.slides.length > 2){
					...
					imgPrev.src = base.options.slides[loadPrev].image;
			...
			if (base.options.slides.length > 1){
				...
				var imgNext = new Image();//$('<img src="'+base.options.slides[loadNext].image+'"/>');
				imgNext.src = base.options.slides[loadNext].image;
...
app.modules.background2 = new trascender({
	properties: {
		name: "background2", 
		label: "Background2",
		icon: "fa-image"
